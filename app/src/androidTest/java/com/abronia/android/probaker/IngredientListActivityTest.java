...
public class IngredientListActivityTest {
    ...
    public ActivityTestRule<IngredientListActivity> mActivityRule =
            new ActivityTestRule<IngredientListActivity>(IngredientListActivity.class) {
                @Override
                protected Intent getActivityIntent() {
                    Context targetContext = InstrumentationRegistry.getInstrumentation()
                            .getTargetContext();
                    Intent result = new Intent(targetContext, IngredientListActivity.class);
                    result.putExtra(IngredientListActivity.ARG_RECIPE_ID,RECIPE_ID);
                    return result;
                }
            };
    ...
    public void ingredientListActivityTest() {
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.list),
                        withParent(withId(R.id.ingredient_list_fragment)),
                        isDisplayed()));
